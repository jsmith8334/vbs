...
sourceFolder = InputBox("Please enter the folder you wish to search: ", "User Input")
'sourceFolder = "C:\Users\jonathanrsmith\.nuget\packages"
destinationFolder = InputBox("Please enter the folder you wish to copy the found files to: ", "User Input")
'destinationFolder = "\\ent.ds.gsa.gov\vdi_apps\Arpit\Packages\10-24-2023"
fileExtension = InputBox("Please enter the file extension you wish to search for: ", "User Input")
'fileExtension = "nupkg"
